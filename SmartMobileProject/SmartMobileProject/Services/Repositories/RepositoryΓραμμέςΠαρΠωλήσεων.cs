...
{
    class RepositoryΓραμμέςΠαρΠωλήσεων : IDataControl
    {
        ...
        Task<string> ConvertToJson(List<ΓραμμέςΠαραστατικώνΠωλήσεων> items)
        {
            var task = Task<string>.Run(() =>
            {
                string json = "{\"ΓραμμέςΠαραστατικώνΠωλήσεων\":[";
